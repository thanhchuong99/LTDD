...
class AddUpdateDishActivity : AppCompatActivity(), View.OnClickListener {
        ...
        if (resultCode == Activity.RESULT_OK) {
            if (requestCode == CAMERA) {
                data?.extras?.let {
                    ...
                    //mBinding.ivDishImage.setImageBitmap(thumbnail) bunun yerine glide kullanarak şu şekilde;
                    Glide.with(this@AddUpdateDishActivity)
                        .load(thumbnail)
                        .centerCrop()
                        .into(mBinding.ivDishImage)

                    mImagePath = saveImageToInternalStoraage(thumbnail)
                        ...
                        .listener(object : RequestListener<Drawable> {
                            ...
                            override fun onResourceReady(
                                ...
                                resource?.let {
                                    ...
                                    mImagePath = saveImageToInternalStoraage(bitmap)
                                    Log.i("ImagePath", mImagePath)
                                }
                                return false
                            }
    ...
    private fun showRationalDialogForPermissions() {
        AlertDialog.Builder(this).setMessage(
            "It looks like you have turned of permissions " +
    ...
    private fun saveImageToInternalStoraage(bitmap: Bitmap): String {
    ...
    private fun customItemsListDialog(
        ...
        val adapter = CustomListItemAdapter(this@AddUpdateDishActivity, itemList, selection)
